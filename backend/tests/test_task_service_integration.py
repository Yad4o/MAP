...
class TestTaskServiceIntegration:
    ...
    async def test_create_task_with_real_db(self, task_service_with_real_repo, db_session, sample_task_data):
        ...
        # Act
        result = await task_service_with_real_repo.create_task(user_id=user_id, data=sample_task_data)
    ...
    async def test_get_task_with_real_db(self, task_service_with_real_repo, db_session, sample_task_data):
        ...
        # Arrange
        user_id = uuid.uuid4()
        created_task = await task_service_with_real_repo.create_task(user_id=user_id, data=sample_task_data)
        
        # Act
        retrieved_task = await task_service_with_real_repo.get_task(task_id=created_task.id, user_id=user_id)
    ...
    async def test_get_task_raises_ownership_error_for_wrong_user_real_db(self, task_service_with_real_repo, db_session, sample_task_data):
        ...
        user1_id = uuid.uuid4()
        user2_id = uuid.uuid4()
        created_task = await task_service_with_real_repo.create_task(user_id=user1_id, data=sample_task_data)
        
        # Act & Assert
        with pytest.raises(TaskOwnershipError):
            await task_service_with_real_repo.get_task(task_id=created_task.id, user_id=user2_id)
    ...
    async def test_list_tasks_with_real_db(self, task_service_with_real_repo, db_session, sample_task_data):
        ...
        user1_id = uuid.uuid4()
        user2_id = uuid.uuid4()
        task1 = await task_service_with_real_repo.create_task(user_id=user1_id, data=sample_task_data)
        task2 = await task_service_with_real_repo.create_task(user_id=user1_id, data=sample_task_data)
        task3 = await task_service_with_real_repo.create_task(user_id=user2_id, data=sample_task_data)
        
        # Act
        user1_tasks = await task_service_with_real_repo.list_tasks(user_id=user1_id)
        user2_tasks = await task_service_with_real_repo.list_tasks(user_id=user2_id)
    ...
    async def test_update_task_with_real_db(self, task_service_with_real_repo, db_session, sample_task_data):
        ...
        updated_task = await task_service_with_real_repo.update_task(
            task_id=created_task.id, user_id=user_id, data=TaskUpdateRequest(**update_data)
        )
    ...
    async def test_delete_task_with_real_db(self, task_service_with_real_repo, db_session, sample_task_data):
        ...
        # Act
        result = await task_service_with_real_repo.delete_task(task_id=created_task.id, user_id=user_id)
        ...
        with pytest.raises(TaskNotFoundError):
            await task_service_with_real_repo.get_task(task_id=created_task.id, user_id=user_id)
    ...
    async def test_delete_task_raises_not_found_for_nonexistent_real_db(self, task_service_with_real_repo, db_session):
        ...
        with pytest.raises(TaskNotFoundError):
            await task_service_with_real_repo.delete_task(task_id=fake_uuid, user_id=fake_user_id)
