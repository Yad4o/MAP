...
class TestTaskRepository:
    ...
    async def test_get_task_by_id(self, task_repo: TaskRepository, test_user: uuid.UUID):
        ...
        created_task = await task_repo.create(test_user, task_data)
    ...
    async def test_get_all_tasks_for_user_with_no_tasks(self, task_repo: TaskRepository, test_user: uuid.UUID):
        ...
        tasks = await task_repo.get_all_by_user(test_user)
        assert tasks == []
...
class TestTaskStepRepository:
    ...
    async def test_get_steps_by_task(self, step_repo: TaskStepRepository, test_user: uuid.UUID):
    ...
    async def test_get_steps_for_task_with_no_steps(self, step_repo: TaskStepRepository, test_user: uuid.UUID):
    ...
    async def test_delete_step(self, step_repo: TaskStepRepository, test_user: uuid.UUID):
