...
class TestTaskService:
    ...
    async def test_create_task_returns_correct_shape(self, task_service, mock_repo, sample_task_data):
        ...
        # Act
        result = await task_service.create_task(None, user_id=1, data=sample_task_data)
    ...
    async def test_get_task_raises_404_for_wrong_user(self, task_service, mock_repo, sample_task_data):
        ...
        created_task = await task_service.create_task(None, user_id=1, data=sample_task_data)
        
        # Act & Assert - try to get task as user 2
        with pytest.raises(HTTPException) as exc_info:
            await task_service.get_task(None, task_id=created_task.id, user_id=2)
    ...
    async def test_get_task_raises_404_for_nonexistent_task(self, task_service):
        ...
        with pytest.raises(HTTPException) as exc_info:
            await task_service.get_task(None, task_id=fake_uuid, user_id=1)
    ...
    async def test_list_tasks_returns_only_user_tasks(self, task_service, mock_repo, sample_task_data):
        ...
        task1 = await task_service.create_task(None, user_id=1, data=sample_task_data)
        task2 = await task_service.create_task(None, user_id=1, data=sample_task_data)
        task3 = await task_service.create_task(None, user_id=2, data=sample_task_data)
        
        # Act
        user1_tasks = await task_service.list_tasks(None, user_id=1)
        user2_tasks = await task_service.list_tasks(None, user_id=2)
    ...
    async def test_update_task_changes_status(self, task_service, mock_repo, sample_task_data, sample_update_data):
        ...
        updated_task = await task_service.update_task(
            None, task_id=created_task.id, user_id=1, data=sample_update_data
        )
    ...
    async def test_update_task_raises_404_for_wrong_user(self, task_service, mock_repo, sample_task_data, sample_update_data):
        ...
        with pytest.raises(HTTPException) as exc_info:
            await task_service.update_task(
                None, task_id=created_task.id, user_id=2, data=sample_update_data
            )
    ...
    async def test_delete_task_returns_true(self, task_service, mock_repo, sample_task_data):
        ...
        # Act
        result = await task_service.delete_task(None, task_id=created_task.id, user_id=1)
        ...
        with pytest.raises(HTTPException):
            await task_service.get_task(None, task_id=created_task.id, user_id=1)
    ...
    async def test_delete_task_raises_404_for_nonexistent_task(self, task_service):
        ...
        fake_uuid = uuid.uuid4()
        with pytest.raises(HTTPException) as exc_info:
            await task_service.delete_task(None, task_id=fake_uuid, user_id=1)
    ...
    async def test_delete_task_raises_404_for_wrong_user(self, task_service, mock_repo, sample_task_data):
        ...
        # Act & Assert
        with pytest.raises(HTTPException) as exc_info:
            await task_service.delete_task(None, task_id=created_task.id, user_id=2)
